...
\subsection{Přehrávání a úprava záznamů} % TOHLE MOZNA SMAZAT nebo jen napsat jak to bude spojeny s bekhendem
...
\subsubsection{Databázový model} \label{subsubsec:navrh_backend_databaze}
