...
Tento konfigurační soubor, pro představu, reprezentuje graf uvedený na obrázku ...
\\
\begin{figure}[h]\centering
	\includegraphics[width=1\textwidth]{images/ulab_receiver.eps}
