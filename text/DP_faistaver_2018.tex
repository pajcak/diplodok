...
\subsection{FFmpeg} \label{subsec:analyza_reseni_ffmpeg}
...
\subsection{Video.js} \label{subsec:analyza_reseni_videojs}
...
\subsection{Open Broadcaster Software} \label{subsec:analyza_reseni_obs}
...
Zda a jak je možné technologii integrovat do systému této práce.
\item \textbf{Komunita\\}
...
Po porovnání všech nashromážděných technologií pomocí specifikovaných charakteristik bylo dosaženo výsledku, který je popsán tabulkou TODO NUM TABLE.
